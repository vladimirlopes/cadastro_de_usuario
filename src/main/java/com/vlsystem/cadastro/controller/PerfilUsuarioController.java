...
import com.vlsystem.cadastro.service.PerfilUsuarioService;

@RestController
@RequestMapping(value = "/perfil-usuario")
@CrossOrigin
public class PerfilUsuarioController {
@Autowired PerfilUsuarioService perfilUsuarioService;
	...
	@PostMapping
	public void addPerfilUsuario(@RequestBody PerfilUsuarioDto perfilUsuario) {
		perfilUsuarioService.addPerfilUsuario(perfilUsuario);
	}
	@PutMapping
